...
def getDataMatrix(year = -1):
    ...
    for row in df_sp.itertuples():
        ...
        #RPI and win percentage
            ...
            #print("wp: {}, wwp: {}, owp: {}, oowp: {}".format(wp0,wwp0,owp0,oowp0))

            #Pythagorean expectation
            data_matrix[row.Index]['pyth_exp_0'] = 1.0/(1 + (team_stats[row.LTeamID]['opp_points']*1.0/team_stats[row.LTeamID]['points'])**8)
            data_matrix[row.Index]['pyth_exp_1'] = 1.0/(1 + (team_stats[row.WTeamID]['opp_points']*1.0/team_stats[row.LTeamID]['points'])**8)
        ...
        #RPI and win percentage
            ...
            data_matrix[row.Index]['win_rate_1'] = wwp1
